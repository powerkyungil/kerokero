			...
			<div class="row">
				<div class="col-lg-6">
					<div class="dt-ceremony-wrap">
						...
						<ul>
							<?php if( get_theme_mod( 'dt_wedding_ceremony_location' ) ) : ?><li><i class="fa fa-map-marker"></i><span><?php echo esc_html( get_theme_mod( 'dt_wedding_ceremony_location' ) ); ?></span></li><?php endif; ?>
							<?php if( get_theme_mod( 'dt_wedding_ceremony_date' ) ) : ?><li><i class="fa fa-calendar"></i> <span><?php echo esc_html( get_theme_mod( 'dt_wedding_ceremony_date' ) ); ?></span></li><?php endif; ?>
							<?php if( get_theme_mod( 'dt_wedding_ceremony_time' ) ) : ?><li><i class="fa fa-clock-o"></i> <span><?php echo esc_html( get_theme_mod( 'dt_wedding_ceremony_time' ) ); ?></span></li><?php endif; ?>
							<?php if( get_theme_mod( 'dt_wedding_ceremony_phone' ) ) : ?><li><i class="fa fa-phone"></i><span><?php echo esc_html( get_theme_mod( 'dt_wedding_ceremony_phone' ) ); ?></span></li><?php endif; ?>
						</ul>
				...
				<div class="col-lg-6">
					<div class="dt-ceremony-wrap">
						...
						<ul>
							<?php if( get_theme_mod( 'dt_wedding_party_location' ) ) : ?><li><i class="fa fa-map-marker"></i><span><?php echo esc_html( get_theme_mod( 'dt_wedding_party_location' ) ); ?></span></li><?php endif; ?>
							<?php if( get_theme_mod( 'dt_wedding_party_date' ) ) : ?><li><i class="fa fa-calendar"></i> <span><?php echo esc_html( get_theme_mod( 'dt_wedding_party_date' ) ); ?></span></li><?php endif; ?>
							<?php if( get_theme_mod( 'dt_wedding_party_time' ) ) : ?><li><i class="fa fa-clock-o"></i> <span><?php echo esc_html( get_theme_mod( 'dt_wedding_party_time' ) ); ?></span></li><?php endif; ?>
							<?php if( get_theme_mod( 'dt_wedding_party_phone' ) ) : ?><li><i class="fa fa-phone"></i><span><?php echo esc_html( get_theme_mod( 'dt_wedding_party_phone' ) ); ?></span></li><?php endif; ?>
						</ul>
					</div><!-- .dt-ceremony-wrap -->
				</div><!-- .col-lg-6 -->
			</div><!-- .row -->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="dt-rsvp-form">
						<h2><?php echo esc_html( get_theme_mod( 'dt_rsvp_title', 'Join Our Wedding' ) ); ?></h2>
...
<?php endif; ?>
	...
	<div class="dt-recent-blog-post">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h2><?php echo esc_html( get_theme_mod( 'dt_recent_post_title' ) ); ?></h2>
							...
							<div class="col-lg-4 col-md-4 dt-recent-blog-post-holder">
								<figure>
									...
									if ( has_post_thumbnail() ) {
										...
										?>
										<a href="<?php the_permalink(); ?>"><?php echo $dt_thumbnail; ?>
